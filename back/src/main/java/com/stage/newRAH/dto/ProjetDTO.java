...
public class ProjetDTO {
	...
	public String toString() {
		return "ProjetDTO [idProjet=" + idProjet + ", nomProjet=" + nomProjet + ", jira=" + jira + ", techno=" + techno
				+ ", service=" + service + ", dateDemande=" + dateDemande + ", livraisonSouhaitee=" + livraisonSouhaitee
				+ ", livraisonRevisee=" + livraisonRevisee + ", affectationCDS=" + affectationCDS
				+ ", priseEnCompteCDS=" + priseEnCompteCDS + ", dateEstimation=" + dateEstimation + ", devisEstimation="
				+ devisEstimation + ", dontGarantie=" + dontGarantie + ", dateFeuVert=" + dateFeuVert
				+ ", dateLivraison=" + dateLivraison + ", MCO=" + MCO + ", datePassageMCO=" + datePassageMCO
				+ ", dateSortieMCO=" + dateSortieMCO + ", commentaires=" + commentaires + ", idClient=" + idClient
				+ ", idEtat=" + idEtat + ", idTypeDefaut=" + idTypeDefaut + ", idTypeProjet=" + idTypeProjet + "]";
	}
